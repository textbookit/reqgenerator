...
const mapDispatch = ({
  useCases: { updateUseCase, shiftUseCaseUp, shiftUseCaseDown, deleteUseCase }
}) => ({
  updateUseCase: (
    id,
    title,
  ...
  render() {
    ...
    return (
      <div className="edit-view">
        <button
          className="save-button sec-button m-xs-all"
          onClick={() => this.handleSave()}
        >
          Save
        </button>
        <button
          className="delete-button sec-bad-button m-xs-all"
            ...
            {Object.values(requirements).map(req => {
              return (
                <RequirementView
                  key={req.id}
                  requirement={req}
                  onClick={() => this.deleteRequirement(req.id)}
        ...
        <div className="parameters">
          <div className="inputs">
            ...
            <button
              className="add-button"
              onClick={() => this.addNewParameter(true)}
            >
              Add Input
            </button>
          </div>
          <div className="outputs">
            ...
            <button
              className="add-button"
              onClick={() => this.addNewParameter(false)}
            >
              Add Output
            </button>
          </div>
